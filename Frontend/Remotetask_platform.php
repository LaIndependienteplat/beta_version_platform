                    ...
                    <div class="col-sm-4">
                        <div class="blog-right">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="./Remotetask_platform.php" class="list-group-item list-group-item-action px-3 border-0 ripple">HiveWork</a>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: #FFCC15;">
                                    ...
                                    aria-current="true" style="background-color: #FFCC15;">Remotetask</a>
